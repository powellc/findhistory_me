...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.lat_long'
        db.alter_column(u'artifacts_location', 'lat_long', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Location.lat_long'
        db.alter_column(u'artifacts_location', 'lat_long', self.gf('django.db.models.fields.CharField')(default='none', max_length=255))
